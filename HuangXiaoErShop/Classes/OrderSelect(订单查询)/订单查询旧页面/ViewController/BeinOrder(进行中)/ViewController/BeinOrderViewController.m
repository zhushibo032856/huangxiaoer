...
@interface BeinOrderViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation BeinOrderViewController
...
- (void)requestDataWithDataString:(NSString *)dataString{
    ...
    NSDate *destDate = [dateFormatter dateFromString:createTime];
    
    NSDate *nextDay = [NSDate dateWithTimeInterval:48*60*60 sinceDate:destDate];//后一天
...
- (void)creatTableView{
    ...
    UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(10, 0, kScreenWidth - 20, 10)];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if ([model.orderType isEqualToString:@"APPOINTMENT"] ||[model.orderType isEqualToString:@"SECKILL"]) {
        ...
        /* 订单 */
        UILabel *orderLable = [[UILabel alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(nameLable.frame) + 45, 50, 15)];
        orderLable.text = @"订单";
